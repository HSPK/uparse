...
from .heuristics import detect_bad_ocr, no_text_found, should_ocr_page
...
def run_ocr(
    doc, pages: List[Page], langs: List[str], rec_model, batch_multiplier=1, ocr_all_pages=False
):
    ocr_pages = 0
    ocr_success = 0
    ocr_failed = 0
