...
from ...schema.block import Block, Span
from ...schema.merged import FullyMergedBlock, MergedBlock, MergedLine
...
def merge_lines(
    blocks: List[List[MergedBlock]], paginate_output: bool = False
    ...
    for idx, page in enumerate(blocks):
        ...
        if paginate_output and idx < len(blocks) - 1:
