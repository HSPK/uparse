...
from .postprocessing.heatmap import get_and_clean_boxes, get_detected_boxes, keep_largest_boxes
from .schema import LayoutBox, LayoutResult, TextDetectionResult
    ...
    for heatmap_idx in range(1, len(id2label)):  # Skip the blank class
        ...
        for bbox in bboxes:
            detected_boxes.append(
                LayoutBox(polygon=bbox.polygon, label=id2label[heatmap_idx], confidence=1)
            )
