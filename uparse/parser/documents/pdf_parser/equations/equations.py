...
from ..schema.block import Block, Line, Span, find_insert_block, split_block_lines
...
def replace_equations(doc, pages: List[Page], texify_model, batch_size: int = 16):
    unsuccessful_ocr = 0
    successful_ocr = 0
    ...
    predictions = get_latex_batched(images, token_counts, texify_model, batch_size=batch_size)
